    ...
    <div className="flex justify-between px-10 p-2 h-[10vh] bg-slate-50">
      <Link to="/">
        <div className="flex gap-3 items-center cursor-pointer">
          ...
          <p className="font-semibold text-3xl font-serif tracking-tight">
            Shop<span className="text-red-700">Kart</span>
          </p>
        </div>
      </Link>
        ...
        <div className="w-full flex">
          <div className="flex w-10/12 relative">
            <input
              type="text"
              value={searchProduct}
              className="p-2 px-6 rounded-l-lg border border-slate-600 
                    w-full placeholder:text-slate-600 "
            ...
            <div className="absolute right-0 top-0 h-full flex justify-center items-center px-3">
              {searchProduct != "" && (
                <RxCross2
                  className="w-5 h-5 cursor-pointer hover:w-6 hover:h-6"
                  onClick={() => {
          ...
          <button
            type="submit"
            className="w-2/12 border border-slate-600 p-2 flex justify-center
                     items-center rounded-r-lg hover:bg-slate-100"
            onClick={() => {
      ...
      <div className="flex gap-3">
        ...
        >
          ...
          <p className="absolute bg-green-900 text-white text-sm font-medium rounded-full w-5 h-5 text-center top-[-4px] right-[-6px]">
            {/* {cartItem.length} */}
            4
          </p>
        </div>
